...
class JDIT(nn.Module):
    def __init__(self, model_config,preprocess_config):
        super(JDIT, self).__init__()
        self.mask_padding = True
        self.fp16_run = False
        self.n_mel_channels = 80
        self.n_frames_per_step = 1
        self.decoder = Decoder()
        self.time_scaler = preprocess_config['preprocessing']['stft']['hop_length'] / float(preprocess_config['preprocessing']['audio']['sampling_rate'])
